...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="rightinfo">
			<form action="../Manager_QutumServlet?flag=add&(${pageContext.request.contextPath }/upload)&signal=<%=role %>" enctype="multipart/form-data" method="post" name="add" target="_self" id="add">
